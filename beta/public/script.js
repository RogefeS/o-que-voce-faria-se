...
function atualizarUI() {
    ...
    if (estado.fase === 'LOBBY') {
        ...
        if (estado.subFase === 'PERGUNTA') {
            ...
            if (meuId === jAtual.id) {
                // Mostra a pergunta que será lida ANTES de clicar
                const previewBox = document.getElementById("preview-leitura");
                previewBox.style.display = "block";
                previewBox.classList.add("liberar"); // Adiciona efeito de pulsação
                ...
                document.getElementById("preview-leitura").style.display = "none";
                document.getElementById("preview-leitura").classList.remove("liberar");
            ...
            if (meuId === jProx.id) {
                // Mostra a resposta que será lida ANTES de clicar
                const previewBox = document.getElementById("preview-leitura");
                previewBox.style.display = "block";
                previewBox.classList.add("liberar"); // Adiciona efeito de pulsação
