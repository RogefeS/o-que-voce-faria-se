    ...
    if (estado.fase === 'LOBBY') {
        ...
        if (estado.subFase === 'PERGUNTA') {
            ...
            if (meuId === jAtual.id) {
                ...
                btnP.disabled = false;
                instrucao.innerHTML = `<span style="color:#ff6b6b; font-weight:bold;">🎤 SUA VEZ!</span><br>Clique para ler a pergunta:`;
            } else {
            ...
            if (meuId === jProx.id) {
                ...
                btnR.disabled = false;
                instrucao.innerHTML = `<span style="color:#4ecdc4; font-weight:bold;">🎤 SUA VEZ!</span><br>Clique para ler a resposta:`;
            } else {
                btnR.style.display = "none";
                btnR.disabled = true;
                aviso.style.display = "block";
